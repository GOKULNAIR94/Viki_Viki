module.exports = function(req, res, callback) {
    ...
    qString = "/hcmCoreSetupApi/resources/11.12.1.0/locations?q=LocationName="+ encodeURIComponent(locValue) + "&fields=LocationName,LocationId&limit=400&onlyData=true";
